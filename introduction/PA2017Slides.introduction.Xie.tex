...
\begin{frame}{How to realize NEMU?}
	\begin{description}
		\item[Devices] C variables, arrays, etc.
		\item[Logic functions] Functions
...
\begin{frame}[fragile]{Structure of PA-1}
\begin{verbatim}
    ics2017
...
\begin{frame}{PA4- Multitask(Protection Extension)}
	\begin{itemize}
	\item Virtual storage based on paging, taking out segment.
	\item Context Switch driven by interruption.
